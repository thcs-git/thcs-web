...
import {
  createUnconfirmedUserRequest,
  registerUnconfirmedUserRequest,
} from "../../../store/ducks/unconfirmeduser/actions";
...
export default function RegisterForm() {
  ...
  const [inputNumberConcil, setInputNumberConcil] = useState({
    value: "",
    error: false,
  });
  ...
  const handlePasswordValitor = useCallback(() => {
    setInputPassword((prev) => ({
      ...prev,
      error: !(
        inputPassword.value.length >= SIZE_INPUT_PASSWORD &&
        inputPasswordConfirm.value &&
        inputPassword.value === inputPasswordConfirm.value
      ),
    }));
    ...
    switch (userSelectType.value) {
      ...
      case "Saúde":
        if (
          ...
          inputProfession.error ||
          inputConcil.error ||
          inputNumberConcil.error ||
          inputSpecialty.error ||
          inputUf.error
        ) {
          return;
        } else {
            ...
            <div className={classes.paper}>
              ...
              <form className={classes.form} noValidate>
                <WelcomeTextWrapper className={classes.formFlexEnd}>
                  <TextGray>Cadastre seus dados no portal:</TextGray>
                </WelcomeTextWrapper>
                <Grid md={6} xs={12} className={classes.formFlexEnd}>
                  <FormControl variant="outlined" size="small" fullWidth>
                    ...
                    <Select
                      ...
                      onChange={(element) =>
                        setUserSelectType({ value: `${element.target.value}` })
                      }
                      labelWidth={60}
                    >
                ...
                <Collapse
                  in={
                    userSelectType.value == "Administrativo" ||
                    userSelectType.value == "Saúde"
                  }
                >
                  <Grid container item md={12} xs={12} className={classes.form}>
                    <Autocomplete
