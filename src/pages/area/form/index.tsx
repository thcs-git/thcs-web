            ...
            <FormContent>
              ...
              <TabContent>
                <TabNav>
                  ...
                  >
                    <Badge
                      badgeContent={state.profession_users.length}
                      max={99}
                      color="primary"
                    >
                      {`Prestadores`}
                      ...
                      <Grid item md={7} xs={12}>
                        <FormGroupSection>
                          <Autocomplete
                            ...
                            onChange={(event, value) => {
                              if (value) {
                                handleSelectNeighborhood(event, {
                                  ...value,
                            ...
                            renderInput={(params) => (
                              <TextField
                                ...
                                InputProps={{
                                  ...
                                  endAdornment: (
                                    <React.Fragment>
                                      {professionState.list.data[0] ? null : (
                                        <CircularProgress
                                          color="inherit"
                                          size={20}
                                        />
