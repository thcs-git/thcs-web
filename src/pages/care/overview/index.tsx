...
export default function PatientOverview(
    ...
    rows.push({name: "CID", value: integration ? careState?.data?.cid_id : careState?.data?.cid_id.name});
    careState?.data?.health_insurance_id &&
    rows.push({
        name: "Convênio",
        value: integration ? {name: careState?.data?.health_insurance_id} : careState?.data?.health_insurance_id,
    });
    careState?.data?.health_plan_id &&
    rows.push({
        name: "Plano",
        value: integration ? {name: careState?.data?.health_plan_id} : careState?.data?.health_plan_id
    });
    careState?.data?.health_sub_plan_id &&
    rows.push({
        name: "Subplano",
        value: integration ? {name: careState?.data?.health_sub_plan_id} : careState?.data?.health_sub_plan_id
    });
    ...
    rows.push({
        ...
        value: integration ? {name: careState?.data?.speciality} : careState?.data?.speciality
    },);
        ...
        <Sidebar>
            ...
            <Container style={{padding: "20px", maxWidth: "1100px"}}>
                ...
                <Container style={{backgroundColor: "#f5f5f5"}}>
                    ...
                    {true ? (
                        <>
                            <Header content={content} allergic={isAllergic(allergiesState)} integration={integration}/>
                            <ScrollCard
