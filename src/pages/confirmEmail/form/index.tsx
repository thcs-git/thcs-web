...
export default function ConfirmEmailForm(props: RouteComponentProps<IPageParams>) {
  ...
  return (
    <FeedbackContent>
      ...
      <FeedbackDescription>Foi enviado um email de ativação para sua o email informado {params.email || ''},<br />
      </FeedbackDescription>
      <FeedbackDescription>
        Por favor verifique seu email para ativar a sua conta.
      </FeedbackDescription>
      <FeedbackDescription>
        Caso você esse email não seja o certo por vafor preencha o campo abaixo e clique em reenviar email
      </FeedbackDescription>
      <TextField
       variant="outlined"
        size="small"
