        ...
        <FormGroupSection>
          {userState.success ? (
            <Grid container direction="column">
              ...
              >
                <FeedbackTitle>Verifique seu email</FeedbackTitle>
              </Grid>
              <Grid item>
                <FeedbackDescription style={{ textAlign: "center" }}>
                  Enviamos um link de recuperação para seu e-mail. Por favor
                  confira sua caixa <br />
                  de entrada e clique no link de confirmação para criar uma nova
                  senha.
                </FeedbackDescription>
              </Grid>
            ...
            <Grid container direction="column">
              {userState.error ? (
                <FeedbackDescription>
                  Infelizmente não foi encontrado um usuário com este email,{" "}
                  <br />
                  cpor favor confirme o email ou enter em contato com o suporte.
                </FeedbackDescription>
              ) : (
                <>
                  <Grid item>
                    <FeedbackTitle>Redefina sua senha</FeedbackTitle>
                  </Grid>
                  <Grid item>
                    <FeedbackDescription>
