              ...
              <Grid container>
                ...
                <Grid item md={9} xs={12}>
                  <TextField
                    ...
                    helperText={!fieldsValidation.number?'Por favor insira uma rua ou avenida válida':null}
                    size="small"
                ...
                <Grid item md={2} xs={12}>
                  <Autocomplete
                    ...
                    renderInput={(params) =>
                      ...
                      disabled={!canEdit}
                      helperText={!fieldsValidation.number?'Por favor insira uma UF válida':null}/>
                    }
