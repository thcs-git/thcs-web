        ...
        >
          ...
          <DialogContent>
            <DialogContentText id="scroll-dialog-description" tabIndex={-1}>
              <p style={{ fontFamily: "Open Sans Bold" }}>
                <h3>Principal</h3>
              </p>
              <br />
              <p
              ...
              >
                {userState.list.data[userIndex]?.main_specialty_id?.name}
              </p>
              <br />
              <p style={{ fontFamily: "Open Sans Bold" }}>
                <h3>Secundária</h3>
              ...
              >
                {userState.list.data[userIndex]?.specialties.map(
                  (specialty, index) =>
                    `${specialty?.name}${
                      index <
                      userState.list.data[userIndex].specialties.length - 1
                        ? ","
                        : ""
                    }`
                )}
