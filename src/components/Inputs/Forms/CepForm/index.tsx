...
const CepForm = (props: IComponent) => {
  const {index, state, setState, setValidations, canEdit, getAddress, cepStatus} = props;
          ...
          <FormControl variant="outlined" size="small" style={{ padding: '0 12px 12px 0', width: '100%'}} >
            ...
            <InputMask
              ...
              onChange={element => {
                ...
                setValidations((prevState: any) => ({ ...prevState, postal_code: !validator.isEmpty(element.target.value) }));
              }}
              onBlur={getAddress}
            >
              {(inputProps: Props) => (
        ...
        <Grid item md={10} xs={12}>
          <TextField
            ...
            onChange={(element) =>{
              ...
              setValidations((prevState: any) => ({ ...prevState, street: !validator.isEmpty(element.target.value) }));
            }
            }
        ...
        <Grid item md={2} xs={12}>
          <TextField
            ...
            onChange={(element) =>{
              ...
              setValidations((prevState: any) => ({ ...prevState, number: !validator.isEmpty(element.target.value) }));
            }}
            fullWidth
            disabled={!canEdit}
        ...
        <Grid item md={4} xs={12}>
          <TextField
            ...
            onChange={(element) =>{ setState({ ...state, address: { ...state.address, district: element.target.value } })
              setValidations((prevState: any) => ({ ...prevState, district: !validator.isEmpty(element.target.value) }));
            }}
            fullWidth
            disabled={!canEdit}
