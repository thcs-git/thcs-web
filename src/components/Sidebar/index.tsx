                                ...
                                <ListItem
                                    ...
                                    onClick={() => {
                                        if (item.route !== '/map') {
                                            ...
                                            const integration_url = sessionStorage.getItem("@sollar_integration");
                                            const external_sector_id = '763'
                                            const company_id = localStorage.getItem("@sollar_company_selected");
                                            const external_company_id = localStorage.getItem("@sollar_integration_company_selected");
                                            const external_user_id = localStorage.getItem("@dollar_integration_user_id");
                                            ...
                                            const hash = CryptoJS.enc.Base64url.stringify(CryptoJS.enc.Utf8.parse(ciphertext.toString()))
                                            window.open(process.env.REACT_APP_BASE_MAP + `/hash/${hash}`, '_blank', 'noopener,noreferrer')
                                        }
                                    }}
                                    sx={{
                                        backgroundColor: `${
