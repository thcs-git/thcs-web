...
import {loadRequestByClient, loadUserById} from "../../store/ducks/users/actions";
import {CompanyUserLinkInterface} from "../../store/ducks/users/types";

import {loadRequest, loadMessageById} from "../../store/ducks/message/actions";
...
export default function Message() {
  ...
  const handleOpenMessageIdModal = useCallback((index) => {
          ...
          <>
            {messageState?.list?.data?.map((item, index) => {
              ...
              return (
                <>
                  ...
                  <ListItem alignItems="flex-start" style={style} button
            ...
            <PaginationComponent
              ...
              handleLastPage={() => dispatch(loadRequest({
                page: (Math.ceil(+messageState.list.total / +messageState.list.limit)).toString(),
                limit: messageState.list.limit,
                total: messageState.list.total,
              }))}
